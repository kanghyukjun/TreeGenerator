...
bool Context::Init(){
    ...
    m_vertexLayout->SetAttrib(2, 2, GL_FLOAT, GL_FALSE, sizeof(float) * 8, sizeof(float) * 6); // texture
...
void Context::Render() {
	...
	m_program->SetUniform("material.diffuse", 0); // 텍스쳐 슬롯 번호
